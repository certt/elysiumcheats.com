...
namespace ImGui
{
	...
	IMGUI_API bool          Tab(const char* label, const ImVec2& size_arg, bool Enabled, int Number);
...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_ChildWindowAutoFitX    = 1 << 29,  // Don't use! For internal use by BeginChild()
	ImGuiWindowFlags_ChildWindowAutoFitY    = 1 << 30  // Don't use! For internal use by BeginChild()
};
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImVec2& pos, float font_size, ImU32 col, const char* text_begin, const char* text_end = NULL);
