...
void ImGui_ImplDX9_RenderDrawLists(ImDrawData* draw_data)
{
	...
	IDirect3DStateBlock9* pixel_state = NULL; IDirect3DVertexDeclaration9* vertDec = NULL; IDirect3DVertexShader9* vertShader = NULL;
	if (g_pd3dDevice->GetVertexDeclaration(&vertDec) < 0 || g_pd3dDevice->GetVertexShader(&vertShader) < 0 || g_pd3dDevice->CreateStateBlock(D3DSBT_PIXELSTATE, &pixel_state) < 0)
		return;
